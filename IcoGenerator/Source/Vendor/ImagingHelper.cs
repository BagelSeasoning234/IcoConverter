...
namespace IcoGenerator.Source.Vendor
{
    class ImagingHelper
    {
        ...
        public static bool IconConversion(Stream input, Stream output, int size = 16, bool preserveAspectRatio = false)
        {
        ...
        public static bool ConvertToIcon(string inputPath, string outputPath, int size = 16, bool preserveAspectRatio = false)
        {
            try
            {
                ...
                {
                    return IconConversion(inputStream, outputStream, size, preserveAspectRatio);
                }
            }
            catch
            {
